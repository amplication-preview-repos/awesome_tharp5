...
import { ClaimStatus } from "../../claimStatus/base/ClaimStatus";
...
export class ClaimResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => ClaimStatus, {
    nullable: true,
    name: "claimStatus",
  })
  @nestAccessControl.UseRoles({
  ...
  async getClaimStatus(
    ...
    const result = await this.service.getClaimStatus(parent.id);
  ...
  async getCustomer(@graphql.Parent() parent: Claim): Promise<Customer | null> {
